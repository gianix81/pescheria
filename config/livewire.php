...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // Il default di Livewire è 12 MB: troppo poco per i video verticali del
        // prodotto. Il limite qui è quello massimo ammesso (MEDIA_MAX_VIDEO_MB);
        // il controllo per tipo (immagini 10 MB, video 100 MB) resta in MediaService.
        'rules' => ['required', 'file', 'max:'.(((int) env('MEDIA_MAX_VIDEO_MB', 100)) * 1024)],
        'directory' => null,                                  // Example: 'tmp'                     | Default: 'livewire-tmp'
        'middleware' => 'throttle:upload',                    // Rate limiting sugli upload (AppServiceProvider)
